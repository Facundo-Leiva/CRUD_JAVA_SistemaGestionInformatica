...
public class InformacionEquipoUI extends JFrame implements ActionListener
{
    private final JTextField model;
    private final JTextField num_ser;
    ...
    EquiposDTO equipDto = equipo.buscarEquipo(InformacionClienteUI.id_equipo);

    public InformacionEquipoUI()
    {
        caractFrame();
     ...
     //============================================================================================================================
        ...
        JTextArea com_act = new JTextArea(equipDto.getComent_tecnico() + "\n\n" + equipDto.getRev_tec_de());
        com_act.setEditable(false);
        caractArea(com_act);
    ...
    public void actionPerformed(ActionEvent e) 
    {
        if (e.getSource() == actualizar)
        {
            if (!Objects.equals(tipo.getSelectedItem(), "") && !Objects.equals(marc.getSelectedItem(), "") && !Objects.equals(estat.getSelectedItem(), "") && !model.getText().equals("") && !num_ser.getText().equals("") && !repor_obser.getText().equals(""))
            {
                ...
                equipo.actualizarEquipo(InformacionClienteUI.id_equipo, GestionarClientesUI.user_id, tipo_eq, marca_eq, model.getText(), num_ser.getText(), equipDto.getDia_ingreso(), equipDto.getMes_ingreso(), equipDto.getAnnio_ingreso(), repor_obser.getText(), estatus_eq, nombreUser(), equipDto.getComent_tecnico(), equipDto.getRev_tec_de());
