...
public class GestionarClientesUI extends JFrame
{
    ...
    public GestionarClientesUI()
    {
        caractFrame();
        setTitle("Clientes Registrados - Sesion de " + nombreUser());
     ...
     //============================================================================================================================
        ...
        titulo.setText("Clientes Registrados");
